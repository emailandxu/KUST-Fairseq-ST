...
class SequenceGenerator(object):
    ...
    def generate_batched_itr(
        self, data_itr, beam_size=1, maxlen_a=0.0, maxlen_b=200,
        ...
        for sample in data_itr:
            ...
            yield self.generate_by_a_sample(sample, beam_size, maxlen_a, maxlen_b,
        cuda, timer, prefix_size)

    def generate_by_a_sample(self, sample, beam_size=1, maxlen_a=0.0, maxlen_b=200,
        cuda=False, timer=None, prefix_size=0,
    ):
        ...
        for i, id in enumerate(s['id'].data):
            ...
            return id, src, ref, hypos[i]


    def generate(self, encoder_input, beam_size=1, maxlen=None, prefix_tokens=None):
    ...
    def _generate(self, encoder_input, beam_size=1, maxlen=None, prefix_tokens=None):
        """See generate"""
