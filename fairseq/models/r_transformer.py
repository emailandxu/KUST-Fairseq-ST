...
@register_model_architecture('r_transformer', 'r_transformer_lm')
...
@register_model_architecture('r_transformer', 'r_transformer_lm_big')
...
@register_model_architecture('r_transformer', 'r_transformer_lm_wiki103')
def speechtransformer_lm_wiki103(args):
    args.dropout = getattr(args, 'dropout', 0.3)
    base_lm_architecture(args)


@register_model_architecture('r_transformer', 'r_transformer_lm_gbw')
