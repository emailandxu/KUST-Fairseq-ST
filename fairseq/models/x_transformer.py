...
class TransformerModel(FairseqModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--encoder-deep-convolutions', type=str, metavar='EXPR',
                            help='encoder layers [(dim, kernel_size), ...]')

        parser.add_argument('--normalization-constant', type=float, default=1.0)
        parser.add_argument('--conv-attention', action='store_true')
        parser.add_argument('--distance-penalty', type=str, default='log',
                            choices=['log', 'llog', 'gauss'],
...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, left_pad=True, convolutions=((512, 3),) * 20, stride=2,
        ...
        deep_convolutions = eval(args.encoder_deep_convolutions) if args.encoder_deep_convolutions is not None else convolutions
        deep_convolutions = extend_conv_spec(deep_convolutions)

        self.convolutions = nn.ModuleList()
        self.deep_convolutions = nn.ModuleList()
        ...
        for i, (out_channels, kernel_size, kernel_width) in enumerate(deep_convolutions):
            if kernel_size % 2 == 1:
                padding = kernel_size // 2
            else:
                padding = 0
            self.deep_convolutions.append(
                Conv2D(in_channels, out_channels, kernel_size,
                       dropout=self.dropout, padding=padding, stride=1)
            )
            in_channels = out_channels
        ...
        self.layers.extend([
            TransformerEncoderLayer(args,layer_number)
            for layer_number in range(args.encoder_layers)
        ])
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False, left_pad=False, final_norm=True):
        ...
        output_embed_dim = args.decoder_out_embed_dim
...
class TransformerEncoderLayer(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, args, layer_number=1):
        super().__init__()
...
@register_model_architecture('x_transformer', 'x_transformer_lm')
...
@register_model_architecture('x_transformer', 'x_transformer_lm_big')
...
@register_model_architecture('x_transformer', 'x_transformer_lm_wiki103')
def speechtransformer_lm_wiki103(args):
    args.dropout = getattr(args, 'dropout', 0.3)
    base_lm_architecture(args)


@register_model_architecture('x_transformer', 'x_transformer_lm_gbw')
...
@register_model_architecture('x_transformer', 'x_transformer_small')
...
@register_model_architecture('x_transformer', 'x_transformer_small_conv')
def speechtransformer_fbk(args):
    args.dropout = getattr(args, 'dropout', 0.3)
    args.normalization_constant = getattr(args, 'normalization_constant', 0.5)
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    ...
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 128)
    args.encoder_convolutions = getattr(args, 'encoder_convolutions', '[(16, 3, 3)] * 2')
    args.encoder_deep_convolutions = getattr(args, 'encoder_convolutions', '[(16, 3, 3)] * 4')
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
...
@register_model_architecture('x_transformer', 'x_transformer_smallplus_conv')
def speechtransformer_fbk(args):
    args.dropout = getattr(args, 'dropout', 0.3)
    args.normalization_constant = getattr(args, 'normalization_constant', 0.5)
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    ...
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 128)
    args.encoder_convolutions = getattr(args, 'encoder_convolutions', '[(16, 3, 3)] * 2')
    args.encoder_deep_convolutions = getattr(args, 'encoder_convolutions', '[(16, 3, 3)] * 5')
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 1024)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_learned_pos = getattr(args, 'encoder_learned_pos', False)
...
@register_model_architecture('x_transformer', 'x_transformer_medium_conv')
def speechtransformer_fbk(args):
    args.dropout = getattr(args, 'dropout', 0.3)
    args.normalization_constant = getattr(args, 'normalization_constant', 0.5)
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    ...
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 128)
    args.encoder_convolutions = getattr(args, 'encoder_convolutions', '[(16, 3, 3)] * 2')
    args.encoder_deep_convolutions = getattr(args, 'encoder_convolutions', '[(16, 3, 3)] * 8')
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 1024)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_learned_pos = getattr(args, 'encoder_learned_pos', False)
...
@register_model_architecture('x_transformer', 'x_transformer_mediumplus_conv')
def speechtransformer_fbk(args):
    args.dropout = getattr(args, 'dropout', 0.3)
    args.normalization_constant = getattr(args, 'normalization_constant', 0.5)
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
    ...
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 128)
    args.encoder_convolutions = getattr(args, 'encoder_convolutions', '[(16, 3, 3)] * 2')
    args.encoder_deep_convolutions = getattr(args, 'encoder_convolutions', '[(16, 3, 3)] * 9')
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 1024)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_learned_pos = getattr(args, 'encoder_learned_pos', False)
...
@register_model_architecture('x_transformer', 'x_transformer_medium')
def speechtransformer_fbk(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    args.normalization_constant = getattr(args, 'normalization_constant', 0.5)
    args.attention_dropout = getattr(args, 'attention_dropout', 0.1)
...
@register_model_architecture('x_transformer', 'x_transformer_medium_red8')
